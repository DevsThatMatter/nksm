...
export async function addProductFromListing(values: formData){
    try {
        ...
        const product = await Product.create({
            ...
            Price: values.price,
            Images: ["https://img.freepik.com/free-vector/beauty-skin-care-background_52683-728.jpg?t=st=1709385459~exp=1709389059~hmac=183b3e043104f8b588aad1a901df1079015dc73367f17d9cdda3f55d19401e11&w=996"],
