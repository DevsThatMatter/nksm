...
const Overlay = ({
  ...
  return (
    ...
    >
      <CarouselContainer
        className={cn(
          "group peer m-auto h-full w-full transform rounded-lg bg-muted shadow-none transition-all aria-expanded:fixed aria-expanded:bottom-0 aria-expanded:left-0 aria-expanded:right-0 aria-expanded:top-0 aria-expanded:z-[51] aria-expanded:max-h-[90vh] aria-expanded:w-[90vw]",
        )}
        ariaExpanded={toggle}
      >
        {children}
