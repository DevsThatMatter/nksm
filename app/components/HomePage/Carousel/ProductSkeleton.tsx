      ...
      <Card className="min-w-[120px] animate-pulse">
        <CardContent className="flex aspect-square items-center justify-center p-3">
            <div className="flex flex-col justify-center">
              <div className="2xl:w-[240px] 2xl:h-48 min-[2000px]:min-w-72 lg:w-48 md:w-56 sm:w-68 min-[240px]:w-32 min-[440px]:w-44 min-[550px]:w-60 bg-gray-400 min-[240px]:h-32 min-[440px]:h-40 sm:h-40 h-56 rounded-md"></div>
